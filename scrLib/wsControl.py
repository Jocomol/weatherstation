...
class controller():
    ...
    def __init__(self):
        ...
        ##Create Objects
        self.logger = logger()
        self.logger.writeLog(self, message="logger created")
    ...
    def control(self):
        ...
        self.logger.writeLog(self, message="Meassuring started")
        dataArray = []
        dataArray.append(getTime())
        tempArray = tempMeassure()
        self.logger.writeLog(self, message=str("Meassured Temperatures:",tempArray[0],tempArray[1],tempArray[2],"write into database soon"))
